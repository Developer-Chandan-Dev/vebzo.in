...
const AboutPage = () => {
  return (
    <>
      <Helmet>
        <title>About Us - Know More About Vebzo</title>
        <meta
          name="description"
          content="Vebzo is dedicated to delivering 100% organic and fresh products to villages and towns. Learn about our mission, values, and journey."
        />
      </Helmet>
      <div className="w-full h-auto">
        ...
        <div className="py-14 px-5 sm:px-10 bg-[#f8f6f3] flex-center gap-4 h-auto  flex-col ">
          <div className="w-11/12 sm:w-[80%] md:w-[65%] flex-center flex-col gap-6">
            ...
            <p className="mt-5 text-[15px] text-gray-700 px-2">
              Welcome to <b>Vebzo</b> - Your trusted local organic store. We are
              dedicated to providing high-quality, fresh, and organic products
              sourced directly from local farmers. Our mission is to promote
              healthy living by making natural and organic products accessible
        ...
        <div className="w-full mx-auto py-5 text-gray-600 px-5 md:w-11/12 text-left flex-center gap-5 flex-wrap ">
          <div className="w-96 p-5 border rounded-md bg-[#f8f6f3] transition-all hover:shadow-xl hover:-translate-y-3">
            ...
            <p>
              We envision a world where everyone has access to fresh, organic,
              and natural products. We aim to become the most trusted name for
              organic shopping in your local area.
            </p>
          </div>
          <div className="w-96 p-5 border rounded-md bg-[#f8f6f3] transition-all hover:shadow-xl hover:-translate-y-3">
            <h2 className="pb-4 text-2xl font-semibold  text-gray-700 amiri-quarn">
        ...
        <div className="w-full mx-auto py-5 text-gray-600 px-10 md:w-11/12 lg:px-14 text-left">
          <h2 className="text-xl font-semibold py-5">Why Choose Vebzo?</h2>
          <table>
            <tbody>
              <tr>
                <td>
          ...
          <br />
          <p>
            Vebzo is more than just a store - it&apos;s a commitment to
