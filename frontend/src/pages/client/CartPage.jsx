...
const CartPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Your Cart - Review Your Organic Items | Vebzo</title>
        <meta
          name="description"
          content="Check your selected organic items before placing the order. Enjoy fresh, healthy, and locally sourced products."
        />
      </Helmet>
