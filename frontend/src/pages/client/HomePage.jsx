...
const HomePage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Vebzo - Local Organic Products at Your Doorstep</title>
        <meta
          name="description"
          content="Buy fresh and organic fruits, vegetables, and groceries directly from local farms. Vebzo brings health and purity to your home."
        />
      </Helmet>
