...
const PrivacyPolicyPage = () => {
  return (
    <>
      <Helmet>
        <title>Vebzo - Privacy Policy</title>
        <meta
          name="description"
        ...
        <div className="py-10 w-full px-5 md:w-[700px] mx-auto">
          ...
          <div className="text-left">
            ...
            <div className="bg-[#f8f6f3] px-4 py-4 border rounded-md my-3">
              ...
              <p>
                Vebzo takes your privacy seriously. This Privacy Policy explains
                how we collect, use, and protect your data. Please read it
                carefully.
              </p>
            </div>
            ...
            <div className="bg-[#f8f6f3] px-4 py-4 border rounded-md my-3">
              ...
              <p>
                We use approriate technical and organizational measures to
                protect your data. However, no internet transmission is
                completely secure.
              </p>
            </div>
