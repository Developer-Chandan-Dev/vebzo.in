        ...
        <div className="text-left">
          ...
          <div className="bg-[#f8f6f3] px-4 py-4 border rounded-md my-3">
            ...
            <p>
              ...
              using the ApnaMarket website. By using our services, you agree to
              these terms.
            </p>
          </div>
          ...
          <div className="bg-[#f8f6f3] px-4 py-4 border rounded-md my-3">
            ...
            <li>Providing accurate and up-to-date information is mandatory.</li>
          ...
          <div className="bg-[#f8f6f3] px-4 py-4 border rounded-md my-3">
            <h2 className="text-xl font-medium py-3">4. Orders and Payments</h2>
          ...
          <div className="bg-[#f8f6f3] px-4 py-4 border rounded-md my-3">
            ...
            <li>
              Requests for returns must be made within [Number of days, e.g., 2
              days] of delivery.
            </li>
          </div>
          ...
          <div className="bg-[#f8f6f3] px-4 py-4 border rounded-md my-3">
            ...
            <li>All content displayed on ApnaMarket is our property.</li>
            <li>
          ...
          <div className="bg-[#f8f6f3] px-4 py-4 border rounded-md my-3">
            ...
            <li>
              ApnaMarket will not be responsible for any indirect, incidental,
